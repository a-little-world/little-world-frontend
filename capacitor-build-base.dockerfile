FROM ubuntu:22.04
# FORK FROM: https://github.com/robingenz/docker-ionic-capacitor/
# Some changes, see: https://github.com/robingenz/docker-ionic-capacitor/issues/4
# & TODO PR for fix
...
ARG IONIC_VERSION=7.1.3
# See https://www.npmjs.com/package/@capacitor/cli
ARG CAPACITOR_VERSION=5.5.1
