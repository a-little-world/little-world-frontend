                ...
                if (fullname_1 === "Microsoft.FSharp.Core.FSharpOption`1[System.Object]") {
                    ...
                    if ((fullName(keyType) === "System.String") ? true : (fullName(keyType) === "System.Guid")) {
                        return (value_12) => fold((target, _arg1) => {
                            const activePatternResult1380 = _arg1;
                            const v_1 = activePatternResult1380[1];
                            const k = activePatternResult1380[0];
                        ...
                        return (value_13) => seq(map_2((_arg2) => {
                            const activePatternResult1384 = _arg2;
                            const v_2 = activePatternResult1384[1];
                            const k_1 = activePatternResult1384[0];
